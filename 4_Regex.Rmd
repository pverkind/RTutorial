...
![](img/dispersion_plot.png)

The black lines show each position in the text where the word is used. 
(every line is the same width; if some lines seem wider, that is because they 
are composed of adjacent thinner lines).

In order to create such a plot, we first have to indentify where our word is
