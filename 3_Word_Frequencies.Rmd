...
differently from Arabic and Persion, we will use al-Ṭabari's *History* as our
example text. 
...
in which we created a book frequency table of token frequencies for al-Ṭabari's
*History*. 

Create a new R script file in your Jockers folder, and name it "Chapter3.R".
...
You can copy this code into your `Chapter3.R` script file. 
